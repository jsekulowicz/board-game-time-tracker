var T=o=>{throw TypeError(o)};var z=(o,e,t)=>e.has(o)||T("Cannot "+t);var d=(o,e,t)=>(z(o,e,"read from private field"),t?t.call(o):e.get(o)),c=(o,e,t)=>e.has(o)?T("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t),h=(o,e,t,a)=>(z(o,e,"write to private field"),a?a.call(o,t):e.set(o,t),t);import{h as N,b as w}from"./utils-COTZCyyf.js";import{i as S,D as C,h as A,n as E,j as k,k as f,a1 as b,Y as p,o as v}from"./index-D-efC_Pj.js";function H(o,e){return(t,a,l)=>{const s=i=>i.renderRoot?.querySelector(o)??null;return N(t,a,{get(){return s(this)}})}}const F=S`
  :host {
    display: block;

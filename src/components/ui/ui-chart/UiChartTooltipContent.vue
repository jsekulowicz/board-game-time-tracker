    ...
    <slot>
      ...
      <div class="grid gap-1.5">
        ...
        >
          ...
          <div :class="cn('flex flex-1 justify-between leading-none gap-x-2', nestLabel ? 'items-end' : 'items-center')">
            <div class="grid gap-1.5">
            ...
            <span v-if="value" class="text-foreground font-mono font-medium tabular-nums">
              {{ valueFormatter ? valueFormatter(value as number) : value.toLocaleString() }}
            </span>
          </div>
        </div>
      </div>
